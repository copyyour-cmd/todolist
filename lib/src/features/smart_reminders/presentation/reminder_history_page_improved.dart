...
class ImprovedReminderHistoryPage extends ConsumerStatefulWidget {
  const ImprovedReminderHistoryPage({super.key});

  static const routePath = '/reminder-history';
  static const routeName = 'reminderHistory';

  @override
  ConsumerState<ImprovedReminderHistoryPage> createState() =>
      _ImprovedReminderHistoryPageState();
}

class _ImprovedReminderHistoryPageState
    extends ConsumerState<ImprovedReminderHistoryPage>
...
class _ImprovedHistoryCard extends StatelessWidget {
  const _ImprovedHistoryCard({
