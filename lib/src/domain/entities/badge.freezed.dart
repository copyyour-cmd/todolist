...
mixin _$Badge {
  ...
  String get icon => throw _privateConstructorUsedError; // emoji 或图标名称
...
// emoji 或图标名称
  ...
  @override
  String toString() {
    return 'Badge(id: $id, name: $name, description: $description, icon: $icon, category: $category, rarity: $rarity, unlockedAt: $unlockedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, description, icon, category, rarity, unlockedAt);
...
abstract class _Badge extends Badge {
  const factory _Badge(
      ...
      final DateTime? unlockedAt}) = _$BadgeImpl;
